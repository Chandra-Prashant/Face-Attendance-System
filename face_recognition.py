...
class Face_Recognition:
    def __init__(self, root):
        ...
        title_lbl = Label(self.root, text="Face Recognition", font=("times new roman", 25, "bold"), bg="black", fg="white")
        title_lbl.place(x=0, y=0, width=1530, height=45)
        
        
        #1st image
        img_top = Image.open(r"Images\Images24.png")
        img_top = img_top.resize((1530,765), Image.ANTIALIAS)
        ...
        b1.place(x=665, y=353, width=200, height=40)

        
    
    #=====Attendance============
    def mark_attendance(self,i,r,n,d):
        with open("app.csv","r+",newline="\n") as f:
